...
export default function BookingSubTabs({ activeSubTab, activeCount, historyCount, onTabChange }: BookingSubTabsProps) {
  return (
    <div className="w-full sm:w-auto flex p-1 bg-slate-200/80 rounded-xl font-mono text-xs font-bold gap-1">
      <button
        onClick={() => onTabChange("active")}
        className={`flex-1 sm:flex-none justify-center px-4 py-2 rounded-lg transition-all flex items-center gap-1.5 cursor-pointer ${
