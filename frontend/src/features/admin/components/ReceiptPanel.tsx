...
export default function ReceiptPanel({
  ...
  return (
    <div className="w-full lg:w-80 lg:flex-shrink-0 bg-slate-50 rounded-2xl p-4 sm:p-5 border border-slate-200 flex flex-col justify-between text-xs space-y-4">
      <div>
