  ...
  return (
    <div className="w-full bg-slate-50 min-h-screen animate-fade-in">
      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-4 py-6 sm:py-12">
        <div className="mb-6 sm:mb-8 flex flex-col gap-4 md:flex-row md:justify-between md:items-start border-b border-slate-200 pb-5 sm:pb-6">
          <div className="min-w-0">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-950 font-sans tracking-tight mb-2">My Bookings & Reservations</h2>
            <p className="text-slate-500 text-[11px] sm:text-xs font-mono leading-relaxed max-w-2xl">
          ...
          <div className="space-y-6">
            {displayedBookings.map((booking) => {
              ...
              return (
                <div
                  key={booking.id}
                  className="bg-white rounded-3xl p-4 sm:p-6 md:p-8 shadow-sm border border-slate-200 flex flex-col xl:flex-row justify-between gap-6 sm:gap-8 transition-all hover:border-slate-300"
                >
                  <div className="flex-1 min-w-0 space-y-5">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 border-b border-slate-100 pb-3">
                      <div>
