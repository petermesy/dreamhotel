...
// Isolated component for the ticking clock widget to prevent 
// re-rendering the entire section's text and layout every second.
  ...
  return (
    <section className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
        {/* Welcome Date/Time Widget (Isolated) */}
        <LiveClockWidget />
